...
float amplitude = 1; // Amplitude of the oscillation in degrees
float frequency = 0.5; // Frequency of the oscillations per second
...
void loop() {
  ...
  float targetAngle = amplitude * sin(phase); // Calculate target angle

  motor.move(targetAngle); // Move motor to target angle
